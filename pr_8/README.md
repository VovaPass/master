...
![](images/srceen1.jpg) \### Настройка параметров подключения
![](images/screen2.jpg)

## Создание датасета в DataLense

![](images/screen3.jpg) \### Написание кода для создания чартов
![](images/screen9.jpg)
...
построения дашбордов Вывод В ходе работы освоен Yandex DataLens для
визуализации сетевой активности. Созданные дашборды позволяют наглядно
анализировать трафик, а применение SQL для классификации потоков
подтвердило практическую ценность инструмента в задачах мониторинга и
безопасности.
